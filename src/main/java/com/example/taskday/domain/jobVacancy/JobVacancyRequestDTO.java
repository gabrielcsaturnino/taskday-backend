...
public record JobVacancyRequestDTO(int totalHoursJob, String title, String description, List<String> desiredExperience, Double dayValue, LocalDate jobDate, String city, String state, Status status) {
}
