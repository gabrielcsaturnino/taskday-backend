    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity httpSecurity) throws Exception {
       return httpSecurity
               ...
               .authorizeHttpRequests(authorize -> authorize
                       ...
                       .requestMatchers(HttpMethod.POST, "/job/addJobVacancy").hasRole("COMPANY")
                       ...
                       .requestMatchers(HttpMethod.GET, "/job/seeAllJobVacancyForCompany").permitAll()
                       .requestMatchers(HttpMethod.GET, "/job/seeEmployeeForJobVacancy").hasRole("COMPANY")
                       ...
                       .requestMatchers(HttpMethod.DELETE, "/company/deleteJobVacancy").hasRole("COMPANY")
